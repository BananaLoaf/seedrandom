...
hash_funcs = [hashlib.md5, hashlib.sha1, hashlib.sha224, hashlib.sha256, hashlib.sha384, hashlib.sha512, hashlib.blake2s, hashlib.blake2b]  # noqa: WPS221
payloads = [
    ([b'First', b'Second'], {}),
    ([b'Second', b'First'], {}),
...
prep_rng = SeededRNG(*payloads[3][0], **payloads[3][1], hash_func=hashlib.md5)  # noqa: WPS221


to_type = [None] * len(payloads)  # noqa: WPS435
to_type[0] = {
    bytes: {
