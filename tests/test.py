...
hash_funcs = [hashlib.md5, hashlib.sha1, hashlib.sha224, hashlib.sha256, hashlib.sha384, hashlib.sha512, hashlib.blake2s, hashlib.blake2b]
payloads = [
    ([b"First", b"Second"], {}),
    ([b"Second", b"First"], {}),
...
def test_zeros(hash_func):
    assert SeededRNG(hash_func=hash_func)._seed == hash_func().digest_size * b"\x00"
